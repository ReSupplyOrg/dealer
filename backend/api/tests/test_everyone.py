...
class TestClients(TestCase):
    ...
    def setUp(self):
        ...
        self.search_stores_url = reverse("search_stores")
        ...
        #self.query_rating_url = reverse("query_rating")
    ...
    def test_search_stores_success(self):
        ...
        response = self.client.post(self.search_stores_url,format='json',data=raw_data,HTTP_session=token["token"])
        self.assertEquals(response.status_code,200)
    ...
    def test_rate_success(self):
        ...
        response = self.client2.post(self.clients_rate_url,format='json',data=raw_data,HTTP_session=token["token"])
        self.assertEquals(response.status_code,200)
    ...
    def test_delete_order_success(self):
        ...
        response = self.client.delete(f"/orders/{uuid}",format='json',data=raw_data,HTTP_session=token["token"])
        self.assertEquals(response.status_code,200)

    def test_query_rate_success(self):
        ...
        response = self.client.get(f"/rating/{uuid}",format='json',data=raw_data,HTTP_session=token["token"])
        self.assertEquals(response.status_code,200)
